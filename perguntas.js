criaCartao(
    'Quem sou eu?',
    '',
    'Me chamo: Ydvir Silva de Souza, Tenho: 1,74m, Peso: 78kg'
)

criaCartao(
    'Minha formação',
    '1º Grau / 2° Grau / 3º Grau / Pós',
    'Estudei Fund I: Escola Bela Vista do Paraíso / Fund II e Med: Colégio Est do PR / Fiz Técnico em Processamento de Dados/Lic Mat PUC/PR / Pós EJA Facinter.'
)

criaCartao(
    'Cursos Extras',
    '',
    '"Datilografia", Programação, Eletrônica, LIBRAS UFPR'
)
